...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        #region Dispositivos Eletrônicos

        Smartphone Celular = new Smartphone("SamSung","S20",2020,"Android",80);
        Celular.Ligar();

        Console.WriteLine(Celular.ObterDescricao());  
        ...
        // string[] operacoes = { "ZBR123456", "ZBR123457", "ZBR123458", "ZBR123456", "ZBR123459", "ZBR123457" };

        // Console.WriteLine("Checando a detecção da fraude:");
        // foreach (var operacao in operacoes)
        // {
        //     detector.AdicionarTransacao(operacao);
        // }

        // // Tentando adicionar uma transação anteriormente adicionada para testar a detecção de duplicatas
        // Console.WriteLine("\nExecutando novamente a operação para testar a detecção:");
        // detector.AdicionarTransacao("ZBR123458");
